...
import { SubjectCard, useGetAllSubjectsQuery } from "@/entities/Subject";
...
const SubjectListPage = () => {
    ...
    if (isLoading) {
        return (_jsxs(Paper, { className: "flex-1 p-2 flex flex-col", variant: "primary", children: [_jsxs("div", { className: "flex gap-3 m-3", children: [_jsx(Button, { onClick: () => nav(getRouteSubjectList()), variant: "link-main", children: "\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B" }), _jsx(Button, { onClick: () => nav(getRouteEventList()), variant: "link-main", children: "\u041C\u0435\u0440\u043E\u043F\u0440\u0438\u044F\u0442\u0438\u044F" }), _jsx(TextField, { value: search, onChange: (e) => setSearch(e.target.value), label: "\u041F\u043E\u0438\u0441\u043A..." })] }), _jsx("div", { className: "flex-1 flex justify-center items-center", children: _jsx(Loader, {}) })] }));
    }
    return (_jsxs(Paper, { className: "flex-1 p-2", variant: "primary", children: [_jsxs("div", { className: "flex gap-3 m-3", children: [_jsx(Button, { onClick: () => nav(getRouteSubjectList()), variant: "link-main", children: "\u041F\u0440\u0435\u0434\u043C\u0435\u0442\u044B" }), _jsx(Button, { onClick: () => nav(getRouteEventList()), variant: "link-main", children: "\u041C\u0435\u0440\u043E\u043F\u0440\u0438\u044F\u0442\u0438\u044F" }), _jsx(TextField, { value: search, onChange: (e) => setSearch(e.target.value), label: "\u041F\u043E\u0438\u0441\u043A..." })] }), currentData.length !== 0 ? (_jsxs(_Fragment, { children: [_jsxs(Typography.Title, { className: "m-2", as: "h4", children: ["\u0421\u0442\u0440\u0430\u043D\u0438\u0446\u0430 ", page] }), _jsx("div", { className: "grid grid-cols-3 max-sm:grid-cols-1 max p-2 gap-3", children: currentData.map((subject) => (_jsx(SubjectCard, { subject: subject }, subject.id))) }), _jsxs("div", { className: "flex justify-center gap-3 m-3", children: [page !== 1 && (_jsx(Button, { onClick: () => setPage((prev) => prev - 1), variant: "link-main", children: "\u041D\u0430\u0437\u0430\u0434" })), page * 20 < Number(data === null || data === void 0 ? void 0 : data.length) && (_jsx(Button, { onClick: () => setPage((prev) => prev + 1), variant: "link-main", children: "\u0412\u043F\u0435\u0440\u0435\u0434" }))] })] })) : (_jsx("div", { className: "flex justify-center items-center min-w-20", children: _jsx(Typography.Title, { as: "h3", children: "\u041F\u0440\u043E\u0441\u0442\u0438\u0442\u0435, \u043D\u0435\u0442 \u043F\u0440\u0435\u0434\u043C\u0435\u0442\u043E\u0432" }) }))] }));
};
