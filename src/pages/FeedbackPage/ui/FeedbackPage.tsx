...
const FeedbackPage = () => {
	...
	const [animStart, setAnimStart] = useState<() => void>(() => {});
	...
	return (
		<>
			<Parad setStartAnim={setAnimStart} />
			<div className="max-w-[700px] w-full mx-auto p-4">
				<Paper className="flex-1 flex flex-col p-2">
					...
					{events.length > 0 && !isLoading ? (
						...
						!isLoading && city && <p className="text-center text-gray-500">Мероприятия в данном городе не найдены.</p>
					)}
				</Paper>
			</div>
		</>
